...
export const strings = {
  ...
  subscriptions: {
    ...
    billingActive: "Billing is active with Square.",
    billingPaused: "Square has paused billing — usually a failed payment. We'll be in touch.",
    billingCancelled: "Billing has been cancelled with Square.",
    billingUnknown: "Billing status reported by Square:",
    billingNone: "Not linked to a Square subscription. Billing is handled directly.",
    billingLastEvent: "Last update from Square",
    billingMismatch: "Square and our records disagree on this subscription — we're looking into it.",
  },
  technologyAssets: {
